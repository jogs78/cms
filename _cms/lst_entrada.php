...
$sys = new sistema();
if( !$sys->puede($_SESSION['id'] ,ENTRADA, LISTAR) ) exit; 
$sys->log( $_SESSION['id'] ,ENTRADA,LISTAR);
?>
...
//	echo "		<th >M</th>\n";
	...
	while (!$recordSet->EOF) {
		...
		echo "		<td><a href=\"frm_entrada.php?ide=" . utf8_decode ( $recordSet->fields["id"] ). "&act=2\">" . $recordSet->fields["titulo"] . "</a></td>\n";
