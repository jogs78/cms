...
$sys = new sistema();
$accion=$_POST["act"];
if( !$sys->puede($_SESSION['id'] , POSTOR , $accion) ) exit;
$idp = $_POST["idp"]; 
$idc = $_POST["idc"]; 
$idu = $_POST["idu"]; 
$sys->currentid = $idp;
//$sys->conn->debug=true;
$e="";
$sql="INSERT INTO propuesta_usuario (idc, idu) VALUES ($idc , $idu) ";
$sqlf=$sql;
...
$sys->currentid = $idp;
$sys->log($_SESSION['id'] , POSTOR, $accion, $sqlf);
?>
...
?>
<BR>REALIZADO... SERA REDIRECCIONADO EN SEGUNDOS.... SI NO DE CLICK <A HREF="lst_postor.php">AQUI </A>
<SCRIPT LANGUAGE="JavaScript">
<!--
//setTimeout( "document.location='lst_postor.php'", <?php echo $t ?> );	
//-->
</SCRIPT>
</body>
</html>